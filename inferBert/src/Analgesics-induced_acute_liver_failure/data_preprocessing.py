...
def preprocess(dataset_dir, dataset_name, out_dir):
    if not os.path.exists(out_dir):
        os.makedirs(out_dir)
    article_read = pd.read_csv(dataset_dir + '/' + dataset_name, delimiter=',', low_memory=False)
...
def main():
    ...
    parser.add_argument('--dataset-dir', type=str, default='../../dat/Analgesics-induced_acute_liver_failure/dataset')
    parser.add_argument('--dataset-name', type=str, default='dataset.csv')
    parser.add_argument('--out-dir', type=str, default='../../dat/Analgesics-induced_acute_liver_failure/proc')
